...
Создать и слить четыре ветки, чтобы было видно разветвление и влито в мастер, одна ветка должна быть слита с разрешением конфликта. Ветки удаляем . Пишем в коммите что в этом коммите было разрешение конфликта.
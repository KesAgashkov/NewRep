...
### 25. Просмотреть все доступные удалённые репозитории
    git remote show

### 26. Отключение удаленного репозитория от локального
    git remote remove <название репозитория>

### 27. Получение изменений из удаленного репозитория
    git pull <название удалённого репозитория>Получение изменений из удаленного репозитория

### 28. Получение изменений из удаленного репозитория

    git push <имя удалённого репозитория> <имя ветки>

### 29. Получение изменений из удаленного репозитория. Команда не обновляет рабочую копию в соответствии с удаленным репозиторием. Она обновляет только ссылочные объекты (указатели, ветки и теги) и скачивает все необходимые файлы в директорию. Внесение изменений в рабочую копиб проекта осуществляется вручную
